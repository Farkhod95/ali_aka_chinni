...
/**
 * This is the model class for table "product_account".
 *
 * @property int $id
 ...
 */
class ProductAccount extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['order_account_id', 'order_account_history_id', 'brand_id', 'product_category_id', 'count', 'type', 'type_sklad_id', 'created_by', 'is_debtor', 'vozvrat_order_id', 'warehouse_id'], 'integer'],
