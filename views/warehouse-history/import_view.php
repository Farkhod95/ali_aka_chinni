        ...
        <div class="panel panel-inverse" data-sortable-id="table-basic-4">
            ...
            <div class="panel-heading">
                <div class="panel-heading-btn">
                    <a href="/warehouse-history/import" class="btn btn-xs  btn-warning"> <i class="fa fa-reply"></i> Orqaga qaytish </a>
                ...
                <h4 class="panel-title"><?= Yii::$app->formatter->asDate($cr_date, 'php:d.m.Y') ?> sanadagi import tovarlar tarixi</h4>
            </div>
            <!-- end panel-heading -->
            <!-- begin panel-body -->
                ...
                <table class="table">
                        ...
                        <tbody>
                            <?php  foreach ($warehouse as $model) { $i = 1; $allCount = 0;?>
                                ...
                                <?php  foreach ($warehouses = WarehouseHistory::find()->andWhere(['brand_id' => $model->brand->id])->andWhere(['cr_date' => $cr_date])->all() as $model1) { ?>
                                    <tr>
                                        <td><?= $i ?></td>
