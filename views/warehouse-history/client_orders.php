        ...
        <div class="panel panel-inverse" data-sortable-id="table-basic-4">
            ...
            <div class="panel-heading">
                <div class="panel-heading-btn">
                    <a href="<?= Url::to(['/warehouse-history/client']) ?>" class="btn btn-xs  btn-info"> <i class="fa fa-reply"></i> Orqaga qaytish </a>
                ...
                <h4 class="panel-title"><?= $customer_fio ?>ning buyurmalar ro'yxati</h4>
            </div>
            <!-- end panel-heading -->
            <!-- begin panel-body -->
                        ...
                        <tbody>
                            <?php  foreach ($array_Products as $model) { $i = 1; $allCount = 0;?>
                                ...
                                <?php  foreach ($warehouses = OrderProducts::find()
                                                ...
                                                ->andWhere(['order_id' => $model['order_id']])->all() as $model1) { ?>
                                    <tr>
                                        <td><?= $i ?></td>
